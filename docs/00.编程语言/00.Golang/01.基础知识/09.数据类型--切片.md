...
举个例子，现在有一个数组`a := [8]int{0, 1, 2, 3, 4, 5, 6, 7}`，切片`s1 := a[:5]`，相应示意图如下。![slice_01](https://img.yluchao.cn/typora/389d1b6cbcf1307ee68cff58df8b962e.png)切片`s2 := a[3:6]`，相应示意图如下：![slice_02](https://img.yluchao.cn/typora/389d1b6cbcf1307ee68cff58df8b962e.png)
